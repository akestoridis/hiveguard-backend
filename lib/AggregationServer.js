...
class AggregationServer {
  constructor(config = {}) {
    ...
    this.insertExtendedAddressesRow = async (widsSensorID, dataEntry) => {
      await this.pool.query(
        'INSERT INTO wids_extended_addresses (wids_sensor_id, extendedaddr, '
        + 'altset, macset, nwkset, earliest, latest) VALUES ($1, $2, $3, $4, '
        + '$5, TO_TIMESTAMP($6), TO_TIMESTAMP($7))',
        [
          widsSensorID,
    ...
    this.insertShortAddressesRow = async (widsSensorID, dataEntry) => {
      await this.pool.query(
        'INSERT INTO wids_short_addresses (wids_sensor_id, panid, shortaddr, '
        + 'altset, macset, nwkset, earliest, latest) VALUES ($1, $2, $3, $4, '
        + '$5, $6, TO_TIMESTAMP($7), TO_TIMESTAMP($8))',
        [
          widsSensorID,
          dataEntry.panid,
          dataEntry.shortaddr,
